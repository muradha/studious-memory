<?php 
  ...
  $angka3 = isset ($_GET["angka3"]) ? $_GET["angka3"]:"0";
  ...
  <body>
    ...
    <div id="atas">
      <ul class="nav nav-tabs">
        ...
        <li><a href="EK.php">Energi Kinetik</a></li>
      </ul>
    </div>
    ...
    <div class="w3-row">
      ...
      <div class="w3-container w3-third">
        <div class="alert alert-info fade in">
          ...
          <strong>EP = </strong>  energi potensial
          <strong>m = </strong>  massa
          <strong>g = </strong>  gravitasi
          <strong>h = </strong>  tinggi benda dari permukaan
        </div>
      </div>
      <div class="w3-container w3-third">
			...
			<div class="container">
				<div class="panel panel-default" style="margin:0 auto;width:500px">
					<div class="panel-heading">
						<h2 class="panel-title">Rumus Energi Potensial</h2>
            <div class="gambar2">
              <img class="img-responsive" src="img/rumusEP.png" width="40%">
            </div>
					</div>
					<div class="panel-body">
						<form name="formkalkulator" method="GET" class="form-horizontal" role="form">
							...
							<div class="form-group">
								<label for="angka2" class="col-lg-2 control-label">Gravitasi</label>
								<div class="col-lg-10">
									<input type="text" class="form-control" name="angka2" placeholder="m/s2">
								</div>
							</div>
              <div class="form-group">
								<label for="angka3" class="col-lg-2 control-label">tinggi</label>
								<div class="col-lg-10">
									<input type="text" class="form-control" name="angka3" placeholder="m">
								</div>
							</div>
							<div class="form-group">
